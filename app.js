...
//3c)
    console.log(pj);            // PJ Masks
    console.log(jake);          //Jake and the Neverland Pirates
...
const {captainAmerica, theHulk} = avengers;
    console.log(captainAmerica);                //Steve Rogers
    console.log(theHulk);                       //Bruce Banner

//4c)
    console.log(captainAmerica, theHulk);          //Steve Rogers Bruce Banner
